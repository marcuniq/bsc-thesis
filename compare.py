...
if __name__ == '__main__':
    ...
    # calc AUC #
    params = zip(user_ids, itertools.repeat(model), itertools.repeat(train), itertools.repeat(test), itertools.repeat(movie_ids))
    ...
    result = easy_parallize(calc_auc, params)
    log = pd.DataFrame(result)
    log.to_csv('model_with_sideinfo_parallel_test.csv')
